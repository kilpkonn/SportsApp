package ee.taltech.kilpkonn.sportsapp.activity
...
import ee.taltech.kilpkonn.sportsapp.C
import ee.taltech.kilpkonn.sportsapp.R
import ee.taltech.kilpkonn.sportsapp.detector.FlingDetector
import ee.taltech.kilpkonn.sportsapp.service.LocationService
import ee.taltech.kilpkonn.sportsapp.component.spinner.CompassMode
import ee.taltech.kilpkonn.sportsapp.component.spinner.DisplayMode
import ee.taltech.kilpkonn.sportsapp.component.spinner.ReplaySpinnerItems
import ee.taltech.kilpkonn.sportsapp.component.spinner.RotationMode
import ee.taltech.kilpkonn.sportsapp.db.ReadDatabaseTask
import ee.taltech.kilpkonn.sportsapp.db.domain.TrackSummary
import ee.taltech.kilpkonn.sportsapp.db.domain.User
import ee.taltech.kilpkonn.sportsapp.db.repository.TrackLocationsRepository
import ee.taltech.kilpkonn.sportsapp.db.repository.TrackSummaryRepository
import ee.taltech.kilpkonn.sportsapp.db.repository.UserRepository
import ee.taltech.kilpkonn.sportsapp.provider.FakeLocationProvider
import ee.taltech.kilpkonn.sportsapp.track.TrackType
import ee.taltech.kilpkonn.sportsapp.track.converters.Converter
import ee.taltech.kilpkonn.sportsapp.track.pracelable.TrackData
import ee.taltech.kilpkonn.sportsapp.track.pracelable.TrackSyncData
import ee.taltech.kilpkonn.sportsapp.track.pracelable.loaction.TrackLocation
import ee.taltech.kilpkonn.sportsapp.track.pracelable.loaction.WayPoint
import ee.taltech.kilpkonn.sportsapp.util.filter.SimpleFilter
